...
- General psychometric tools: [`psycho`](https://cran.r-project.org/package=psycho)
- Item Response Theory: [`ltm`](https://cran.r-project.org/package=ltm)
...
- [`AER`](https://cran.r-project.org/package=AER): Applied Econometris with R
