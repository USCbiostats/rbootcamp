...
<blockquote class="imgur-embed-pub" lang="en" data-id="a/abbAY"><a href="//imgur.com/abbAY">Futurama stock market gif</a></blockquote><script async src="//s.imgur.com/min/embed.js" charset="utf-8"></script>
...
*   The value of your monthly savings at month $n$ is described by the following equation
    ...
    Where $S_n$ is your savings balance in time $n$, $i_n\sim I$ is the return rate in time $n$, $W_n$ is your income in time $n$, and $t_n$ is your contribution rate in time $n$.
...
1.  Draw a vector `i` of length `N` from the distribution of the returns, `I`,
...
sample_dow <- function(n=100) {
  sample(dow_monthly$r[-1], n, replace = TRUE)
}
```
