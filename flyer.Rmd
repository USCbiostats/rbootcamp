...
<img src="trojan-rlogo.svg" style="width:300px">

# R Bootcamp for Scientific Computing

## What

The Division of Biostatistics will be helding a **bootcamp for incoming Master and Ph.D. students on the <a target="_blank" href="https://wikipedia.org/wiki/R_(programming_language)">R programming Language</a>**. This week-long Rbootcamp will hands-on intensive and will be composed of a mix of presentations, in-class assignments, and a final R programming project.

## When

The bootcamp will be scheduled as follows:

* **Lecture 1**: Monday 13, 10 AM to 2 PM, SSB Room 116
